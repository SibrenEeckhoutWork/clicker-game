...
const WORLDS = {
  cash: {
    ...
    description: 'It starts small. Wages, savings, the old tin on the shelf.',
    assets: [
      { id: 'piggybank',   name: 'Piggy Bank',         cost: 15,      eps: 0.1,  flavour: 'Old tin on the shelf' },
      { id: 'sidehustle',  name: 'Side Hustle',        cost: 100,     eps: 0.5,  flavour: 'Selling stuff online' },
      { id: 'bankaccount', name: 'Savings Account',    cost: 500,     eps: 2,    flavour: '0.01% interest, classic' },
      { id: 'freelance',   name: 'Freelance Contract', cost: 2000,    eps: 8,    flavour: 'Invoice sent, waiting...' },
      { id: 'rental',      name: 'Room Rental',        cost: 10000,   eps: 30,   flavour: 'Student flat downtown' },
    ],
    upgrades: [
      { id: 'overtime',  name: 'Overtime',          desc: 'Click yield ×2',          cost: 1000,    mult: 2, target: 'click' },
      { id: 'compound',  name: 'Compound Interest', desc: 'All Cash assets ×2',      cost: 5000,    mult: 2, target: 'world' },
      { id: 'taxopt',    name: 'Tax Optimisation',  desc: 'All Cash assets ×2',      cost: 25000,   mult: 2, target: 'world' },
      { id: 'autopilot', name: 'Banking Autopilot', desc: 'Click yield ×3',          cost: 50000,   mult: 3, target: 'click' },
    ],
  },
  crypto: {
    id: 'crypto',
    ...
    description: '24/7 markets. Volatile, fast, and the fans never stop screaming.',
    assets: [
      { id: 'wallet',   name: 'Crypto Wallet', cost: 5_000,      eps: 25,        flavour: 'HODL mentality' },
      { id: 'miner',    name: 'GPU Miner',     cost: 25_000,     eps: 150,       flavour: 'Fan noise included' },
      { id: 'staking',  name: 'Staking Node',  cost: 100_000,    eps: 600,       flavour: 'Passive yield farming' },
      { id: 'exchange', name: 'Own Exchange',  cost: 1_000_000,  eps: 5_000,     flavour: '0.1% fee on everything' },
    ...
    upgrades: [
      ...
      { id: 'whale',    name: 'Whale Wallet',     desc: 'All Crypto assets ×2',  cost: 500_000,    mult: 2, target: 'world' },
      { id: 'launchpad',name: 'Launchpad Access', desc: 'All Crypto assets ×2',  cost: 5_000_000,  mult: 2, target: 'world' },
      { id: 'liquidity',name: 'Liquidity Boost',  desc: 'All Crypto assets ×3',  cost: 50_000_000, mult: 3, target: 'world' },
    ],
  },
  stocks: {
    id: 'stocks',
    ...
    description: 'Long term, compounding returns. Time is your greatest leverage.',
    assets: [
      { id: 'etf',          name: 'World ETF',           cost: 50_000,         eps: 200,        flavour: 'VWCE enjoyer' },
      { id: 'stockpick',    name: 'Stock Position',      cost: 250_000,        eps: 1_200,      flavour: '"I did my research"' },
      { id: 'divportfolio', name: 'Dividend Portfolio',  cost: 1_000_000,      eps: 6_000,      flavour: 'Quarterly payouts' },
      { id: 'hedgefund',    name: 'Hedge Fund',          cost: 50_000_000,     eps: 300_000,    flavour: '2 and 20 fees' },
    ...
    upgrades: [
      ...
      { id: 'options',  name: 'Options Trading',     desc: 'All Stocks assets ×2',    cost: 10_000_000,   mult: 2, target: 'world' },
      { id: 'algo',     name: 'Algorithmic Trading', desc: 'All Stocks assets ×2',    cost: 100_000_000,  mult: 2, target: 'world' },
      { id: 'insider',  name: 'Insider Tip',         desc: '"Don\'t tell anyone" ×3', cost: 1_000_000_000,mult: 3, target: 'world' },
    ],
  },
  restate: {
    id: 'restate',
    ...
    description: 'Concrete, glass, and long-term contracts. Slower start, massive compound.',
    assets: [
      { id: 'studio',        name: 'Studio Apartment',  cost: 200_000,         eps: 800,        flavour: 'City centre location' },
      { id: 'building',      name: 'Apartment Building',cost: 2_000_000,       eps: 10_000,     flavour: '12 units, one elevator' },
      { id: 'office',        name: 'Office Complex',    cost: 20_000_000,      eps: 120_000,    flavour: '"Premium A-location"' },
      { id: 'shoppingcenter',name: 'Shopping Centre',   cost: 500_000_000,     eps: 3_500_000,  flavour: 'Anchor tenant: Zara' },
      { id: 'skyscraper',    name: 'Skyscraper',        cost: 10_000_000_000,  eps: 80_000_000, flavour: 'Name on the building' },
    ],
    upgrades: [
      { id: 'renovate', name: 'Premium Renovation', desc: 'All RE assets ×2',    cost: 50_000_000,    mult: 2, target: 'world' },
      { id: 'lease',    name: 'Long-term Leases',   desc: 'All RE assets ×2',    cost: 500_000_000,   mult: 2, target: 'world' },
      { id: 'reit',     name: 'REIT Structure',     desc: 'Click yield ×3',      cost: 2_000_000_000, mult: 3, target: 'click' },
      { id: 'offshore', name: 'Offshore Holding',   desc: 'All RE assets ×3',    cost: 20_000_000_000,mult: 3, target: 'world' },
    ],
  },
};
...
const ACHIEVEMENTS = [
  { id: 'firstEuro',      label: 'First Euro',             check: g => g.totalEarned >= 1 },
  { id: 'thousandaire',   label: 'Thousandaire',           check: g => g.totalEarned >= 1_000 },
  { id: 'firstAsset',     label: 'First Investment',       check: g => Object.values(g.worlds).some(w => Object.values(w.assets).some(c => c >= 1)) },
  { id: 'tenOfOne',       label: 'Economies of Scale',     check: g => Object.values(g.worlds).some(w => Object.values(w.assets).some(c => c >= 10)) },
  { id: 'cryptoUnlocked', label: 'Into the Blockchain',    check: g => g.worlds.crypto.unlocked },
  { id: 'millionaire',    label: 'Millionaire',            check: g => g.totalEarned >= 1_000_000 },
  { id: 'stocksUnlocked', label: 'Wall Street Arrival',    check: g => g.worlds.stocks.unlocked },
  { id: 'billionaire',    label: 'Billionaire',            check: g => g.totalEarned >= 1_000_000_000 },
  { id: 'restateUnlocked',label: 'Concrete & Steel',       check: g => g.worlds.restate.unlocked },
  { id: 'diversified',    label: 'Diversified Portfolio',  check: g => WORLD_ORDER.every(w => g.worlds[w].unlocked) },
...
const TICKER_LINES = [
  { sym: 'VWCE.AS',   pct:  0.42, text: 'Passive investing remains popular' },
  { sym: 'BTC/EUR',   pct: 12.31, text: 'Analyst: "This time it\'s different"' },
  { sym: 'ETH/EUR',   pct: -3.18, text: 'Layer-2 volume hits new all-time high' },
  { sym: 'ASML.AS',   pct:  1.86, text: 'EUV order intake continues to accelerate' },
  { sym: 'JPM',       pct: -0.74, text: 'Banking sector shows resilience' },
  { sym: 'REIT',      pct:  0.91, text: 'City-centre property prices rise again' },
  { sym: 'FED',       pct:  0.00, text: 'Fed holds rates steady — markets respond positively' },
  { sym: 'IPO',       pct:  null, text: 'New IPO expected: subscribe before Friday' },
  { sym: 'EUR/USD',   pct:  0.12, text: 'ECB chair speaks at 14:00 CET' },
  { sym: 'GOLD',      pct:  2.04, text: 'Gold breaks through €2,500/oz again' },
  { sym: 'SOL/EUR',   pct:  8.77, text: 'Solana ecosystem under the spotlight' },
  { sym: 'BNB/EUR',   pct: -1.24, text: 'Exchange announces new fiat on-ramp' },
  { sym: 'OIL',       pct: -0.55, text: 'Brent falls on oversupply concerns' },
  { sym: 'SP500',     pct:  0.31, text: 'S&P 500 opens higher on jobs data' },
  { sym: 'NASDAQ',    pct:  0.18, text: 'Tech leads gains, defensives trail' },
  { sym: 'CRYPTO',    pct:  null, text: 'Regulators clarify crypto custody rules' },
  { sym: 'REIT',      pct:  0.62, text: 'Logistics real estate delivers strong yield' },
  { sym: 'DAX',       pct: -0.21, text: 'German industry awaits stimulus package' },
];
